  ...
  return `<div class="grid grid2">
    <div class="card">
      ...
      <div style="margin-top:16px">
        ${compVal('Tasa de Agendamiento',c.appointment_rate*100,fmtPct(c.appointment_rate))}
        ${compVal('Tasa de Avance del Embudo',c.movement_rate*100,fmtPct(c.movement_rate))}
        ${compVal('Tasa de Leads Activos',c.crm_activity*100,fmtPct(c.crm_activity))}
        ${compVal('Calidad de Atribución',c.attribution_quality*100,fmtPct(c.attribution_quality))}
        ${compVal('Tasa de Contactabilidad',c.acquisition_score||75,(c.acquisition_score||75)+'%')}
      </div>
    </div>
    <div class="card">
      <h3>KPIs del Cliente</h3>
      <div class="grid grid2" style="margin-top: 14px; gap: 14px;">
        <div style="background: rgba(255,255,255,0.01); border: 1px solid var(--line); padding: 16px; border-radius: 14px; text-align: center;">
          <div class="metric" style="font-size: 32px; background:none; color:#fff; -webkit-text-fill-color: initial;">${fmtNum(c.leads)}</div>
          <div class="label" style="font-size: 12px; color: var(--muted); margin-top:4px;">Leads Totales</div>
        </div>
        <div style="background: rgba(255,255,255,0.01); border: 1px solid var(--line); padding: 16px; border-radius: 14px; text-align: center;">
          <div class="metric" style="font-size: 32px; background:none; color:#fff; -webkit-text-fill-color: initial;">${c.appointments}</div>
          <div class="label" style="font-size: 12px; color: var(--muted); margin-top:4px;">Citas Confirmadas</div>
        </div>
        <div style="background: rgba(255,255,255,0.01); border: 1px solid var(--line); padding: 16px; border-radius: 14px; text-align: center;">
          <div class="metric" style="font-size: 32px; background:none; color:#fff; -webkit-text-fill-color: initial;">${fmtPct(c.appointment_rate)}</div>
          <div class="label" style="font-size: 12px; color: var(--muted); margin-top:4px;">Appointment Rate</div>
        </div>
        <div style="background: rgba(255,255,255,0.01); border: 1px solid var(--line); padding: 16px; border-radius: 14px; text-align: center;">
          <div class="metric" style="font-size: 32px; background:none; color:#fff; -webkit-text-fill-color: initial;">${fmtPct(c.crm_activity)}</div>
          <div class="label" style="font-size: 12px; color: var(--muted); margin-top:4px;">CRM Activity</div>
        </div>
      </div>
    </div>
  </div>
...
function pipelineAnalytics(c){
  ...
  return `<div class="card">
    <div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 12px; margin-bottom: 12px;">
      <div>
        <h3 style="margin: 0;">Sequential Pipeline Progression</h3>
        <p class="small" style="margin: 4px 0 0 0;">Flujo secuencial de conversión basado en las etapas del embudo.</p>
      </div>
      <button onclick="downloadPipelinePDF()" style="background:var(--purple); border:none; color:white; padding:8px 18px; border-radius:999px; font-weight:600; cursor:pointer; display:flex; align-items:center; gap:8px; font-size:13px; font-family:'Inter',sans-serif; transition:background 0.2s; margin-top:-2px;" onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'"><i class="ph ph-file-pdf" style="font-size:16px;"></i> Descargar PDF</button>
    </div>
    <div class="progression-summary">
      <div class="summary-tile">
        <div class="summary-label" style="display:flex; align-items:center; gap:5px; justify-content:center;">
          ...
          <span class="trd-tooltip-container">
            <i class="ph ph-info" style="cursor:pointer; font-size:14px; color:var(--muted);"></i>
            <span class="trd-tooltip-text">
              Mide la proporción de leads que interactuaron o hicieron consultas sobre el total de leads CRM.<br><br>
              <strong>Fórmula:</strong> Leads en Atender Dudas / Total de Leads CRM
            </span>
          </span>
        </div>
      ...
      <div class="summary-tile">
        <div class="summary-label" style="display:flex; align-items:center; gap:5px; justify-content:center;">
          ...
          <span class="trd-tooltip-container">
            <i class="ph ph-info" style="cursor:pointer; font-size:14px; color:var(--muted);"></i>
            <span class="trd-tooltip-text">
              Mide el porcentaje de leads que dejaron de responder al seguimiento sobre el total de leads CRM.<br><br>
              <strong>Fórmula:</strong> Leads en Dejó de Responder / Total de Leads CRM
            </span>
          </span>
        </div>
      ...
      <div class="summary-tile">
        <div class="summary-label" style="display:flex; align-items:center; gap:5px; justify-content:center;">
          ...
          <span class="trd-tooltip-container">
            <i class="ph ph-info" style="cursor:pointer; font-size:14px; color:var(--muted);"></i>
            <span class="trd-tooltip-text">
              Mide el porcentaje de leads del total que concretaron una cita comercial confirmada.<br><br>
              <strong>Fórmula:</strong> Leads en Agendado / Total de Leads CRM
            </span>
          </span>
        </div>
      ...
      <div class="summary-tile">
        <div class="summary-label" style="display:flex; align-items:center; gap:5px; justify-content:center;">
          ...
          <span class="trd-tooltip-container">
            <i class="ph ph-info" style="cursor:pointer; font-size:14px; color:var(--muted);"></i>
            <span class="trd-tooltip-text">
              Mide el porcentaje de leads calificados para re-contacto a futuro del total de leads CRM.<br><br>
              <strong>Fórmula:</strong> Leads en Lead Futuro / Total de Leads CRM
            </span>
          </span>
        </div>
          ...
          <div class="matrix-card">
            ...
            ${Object.entries(c.engine_components).map(([k,v])=>`
              <div class="component" style="grid-template-columns:160px 1fr 36px;margin:10px 0; gap:8px;">
                <span style="font-size:12px; color:#cbd5e1; font-weight:500;">${engineLabels[k] || k}</span><div class="progress" style="--w:${Math.round(v * w[k])}%"><i></i></div><strong>${Math.round(v * w[k])}</strong>
              </div>`).join('')}
          </div>`).join('')}
      </div>
    </div>`);
